    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppPhoneCatalog.Catalog', verbose_name='Чат под загадкой')),
            ],
        ),
    ]
